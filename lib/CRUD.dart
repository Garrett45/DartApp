...
//does some basic crud operations I'm interested in looking into
...
class FirebaseDemoScreen extends StatelessWidget {
  ...
  void createRecord(){
    ...
    data['title'] = 'Mastering EJB';
    data['description'] = 'Programming Guide for J2EE';

    databaseReference.child("1").set(data);
